...
namespace DEFRA.NE.BNG.Integration.Domain.Models
{
	...
	public enum bng_notify_instancetypecode
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum bng_notify_prioritycode
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum bng_notify_statecode
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum bng_notify_statuscode
	{
	...
	/// <summary>
	/// This table is used to send notification details to Gov Notify
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("bng_notify")]
	public partial class bng_Notify : Microsoft.Xrm.Sdk.Entity
	{
		...
		public const string EntityLogicalName = "bng_notify";
		
		public const string EntityLogicalCollectionName = "bng_notifies";
		
		public const string EntitySetName = "bng_notifies";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_account")]
		public Microsoft.Xrm.Sdk.EntityReference bng_Account
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("bng_account");
			}
			set
			{
				this.SetAttributeValue("bng_account", value);
			}
		}
		
		/// <summary>
		/// This is a global option set for the notify action
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_actiontype")]
		public virtual bng_notifytype? bng_ActionType
		{
			get
			{
				return ((bng_notifytype?)(EntityOptionSetEnum.GetEnum(this, "bng_actiontype")));
			}
			set
			{
				this.SetAttributeValue("bng_actiontype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		/// <summary>
		/// This field stores the Registration Applicant
		/// </summary>
		...
		/// <summary>
		/// This column is used to set the Gov notify response ID
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_externalnotifyid")]
		public string bng_ExternalNotifyID
		{
			get
			{
				return this.GetAttributeValue<string>("bng_externalnotifyid");
			}
			set
			{
				this.SetAttributeValue("bng_externalnotifyid", value);
			}
		}
		
		/// <summary>
		/// The field stores the retry count for the failed notification
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_retrycount")]
		public System.Nullable<int> bng_RetryCount
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("bng_retrycount");
			}
			set
			{
				this.SetAttributeValue("bng_retrycount", value);
			}
		}
		...
		public virtual bng_notify_instancetypecode? InstanceTypeCode
		{
			get
			{
				return ((bng_notify_instancetypecode?)(EntityOptionSetEnum.GetEnum(this, "instancetypecode")));
			}
		}
		...
		public virtual bng_notify_prioritycode? PriorityCode
		{
			get
			{
				return ((bng_notify_prioritycode?)(EntityOptionSetEnum.GetEnum(this, "prioritycode")));
			}
			set
			{
		...
		public virtual bng_notify_statecode? StateCode
		{
			get
			{
				return ((bng_notify_statecode?)(EntityOptionSetEnum.GetEnum(this, "statecode")));
			}
			set
			{
		...
		public virtual bng_notify_statuscode? StatusCode
		{
			get
			{
				return ((bng_notify_statuscode?)(EntityOptionSetEnum.GetEnum(this, "statuscode")));
			}
			set
			{
		...
		/// <summary>
		/// 1:N bng_notify_Annotations
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bng_notify_Annotations")]
		public System.Collections.Generic.IEnumerable<DEFRA.NE.BNG.Integration.Domain.Models.Annotation> bng_notify_Annotations
		{
			get
			{
				return this.GetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.Annotation>("bng_notify_Annotations", null);
			}
			set
			{
				this.SetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.Annotation>("bng_notify_Annotations", null, value);
			}
		}
		
		/// <summary>
		/// N:1 account_bng_Notifies
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("account_bng_Notifies")]
		public DEFRA.NE.BNG.Integration.Domain.Models.Account account_bng_Notifies
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Account>("account_bng_Notifies", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Account>("account_bng_Notifies", null, value);
			}
		}
		
		/// <summary>
		/// N:1 bng_Account_Account_bng_Notify
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_account")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bng_Account_Account_bng_Notify")]
		public DEFRA.NE.BNG.Integration.Domain.Models.Account bng_Account_Account_bng_Notify
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Account>("bng_Account_Account_bng_Notify", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Account>("bng_Account_Account_bng_Notify", null, value);
			}
		}
		
		/// <summary>
		/// N:1 bng_bng_notify_ApplicantID_contact
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_applicantid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bng_bng_notify_ApplicantID_contact")]
		public DEFRA.NE.BNG.Integration.Domain.Models.Contact bng_bng_notify_ApplicantID_contact
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Contact>("bng_bng_notify_ApplicantID_contact", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Contact>("bng_bng_notify_ApplicantID_contact", null, value);
			}
		}
		
		/// <summary>
		/// N:1 bng_case_bng_Notifies
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bng_case_bng_Notifies")]
		public DEFRA.NE.BNG.Integration.Domain.Models.bng_Case bng_case_bng_Notifies
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.bng_Case>("bng_case_bng_Notifies", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.bng_Case>("bng_case_bng_Notifies", null, value);
			}
		}
		
		/// <summary>
		/// N:1 bng_developerregistration_bng_Notifies
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bng_developerregistration_bng_Notifies")]
		public DEFRA.NE.BNG.Integration.Domain.Models.bng_DeveloperRegistration bng_developerregistration_bng_Notifies
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.bng_DeveloperRegistration>("bng_developerregistration_bng_Notifies", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.bng_DeveloperRegistration>("bng_developerregistration_bng_Notifies", null, value);
			}
		}
		
		/// <summary>
		/// N:1 bng_gainsiteregistration_bng_Notifies
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bng_gainsiteregistration_bng_Notifies")]
		public DEFRA.NE.BNG.Integration.Domain.Models.bng_GainSiteRegistration bng_gainsiteregistration_bng_Notifies
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.bng_GainSiteRegistration>("bng_gainsiteregistration_bng_Notifies", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.bng_GainSiteRegistration>("bng_gainsiteregistration_bng_Notifies", null, value);
			}
		}
		
		/// <summary>
		/// N:1 bng_notify_team_owningteam
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("owningteam")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("bng_notify_team_owningteam")]
		public DEFRA.NE.BNG.Integration.Domain.Models.Team bng_notify_team_owningteam
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Team>("bng_notify_team_owningteam", null);
			}
		}
		
		/// <summary>
		/// N:1 contact_bng_Notifies
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("contact_bng_Notifies")]
		public DEFRA.NE.BNG.Integration.Domain.Models.Contact contact_bng_Notifies
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Contact>("contact_bng_Notifies", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Contact>("contact_bng_Notifies", null, value);
			}
		}
		
		/// <summary>
		/// N:1 invoice_bng_Notifies
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("invoice_bng_Notifies")]
		public DEFRA.NE.BNG.Integration.Domain.Models.Invoice invoice_bng_Notifies
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Invoice>("invoice_bng_Notifies", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Invoice>("invoice_bng_Notifies", null, value);
			}
		}
		
		/// <summary>
		/// N:1 salesorder_bng_Notifies
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("salesorder_bng_Notifies")]
		public DEFRA.NE.BNG.Integration.Domain.Models.SalesOrder salesorder_bng_Notifies
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.SalesOrder>("salesorder_bng_Notifies", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.SalesOrder>("salesorder_bng_Notifies", null, value);
			}
		}
	}
}
