...
namespace DEFRA.NE.BNG.Integration.Domain.Models
{
	...
	public partial class Product : Microsoft.Xrm.Sdk.Entity
	{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_distinctiveness")]
		public virtual bng_distinctiveness? bng_Distinctiveness
		{
			get
			{
				return ((bng_distinctiveness?)(EntityOptionSetEnum.GetEnum(this, "bng_distinctiveness")));
			}
			set
			{
				this.SetAttributeValue("bng_distinctiveness", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_productgroup")]
		public Microsoft.Xrm.Sdk.EntityReference bng_ProductGroup
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("bng_productgroup");
			}
			set
			{
				this.SetAttributeValue("bng_productgroup", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("bng_producttier")]
		public Microsoft.Xrm.Sdk.EntityReference bng_ProductTier
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("bng_producttier");
			}
			set
			{
				this.SetAttributeValue("bng_producttier", value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DEFRA.NE.BNG.Integration.Domain.Models.Annotation> Product_Annotation
		{
			get
			{
				return this.GetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.Annotation>("Product_Annotation", null);
			}
			set
			{
				this.SetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.Annotation>("Product_Annotation", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DEFRA.NE.BNG.Integration.Domain.Models.SalesOrderDetail> product_order_details
		{
			get
			{
				return this.GetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.SalesOrderDetail>("product_order_details", null);
			}
			set
			{
				this.SetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.SalesOrderDetail>("product_order_details", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DEFRA.NE.BNG.Integration.Domain.Models.Product> Referencedproduct_parent_product
		{
			get
			{
				return this.GetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.Product>("product_parent_product", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<DEFRA.NE.BNG.Integration.Domain.Models.Product>("product_parent_product", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public DEFRA.NE.BNG.Integration.Domain.Models.Product Referencingproduct_parent_product
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Product>("product_parent_product", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.Product>("product_parent_product", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public DEFRA.NE.BNG.Integration.Domain.Models.UoM unit_of_measurement_products
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.UoM>("unit_of_measurement_products", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.UoM>("unit_of_measurement_products", null, value);
			}
		}
		...
		public DEFRA.NE.BNG.Integration.Domain.Models.UoMSchedule unit_of_measurement_schedule_products
		{
			get
			{
				return this.GetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.UoMSchedule>("unit_of_measurement_schedule_products", null);
			}
			set
			{
				this.SetRelatedEntity<DEFRA.NE.BNG.Integration.Domain.Models.UoMSchedule>("unit_of_measurement_schedule_products", null, value);
			}
		}
	}
}
